...
<div align="center">
  ...
  <a href="https://youtu.be/CzULPhI44yg">
    <img src="https://img.youtube.com/vi/CzULPhI44yg/maxresdefault.jpg" alt="Watch the Virtual Tour" style="width:80%; border-radius: 10px; border: 2px solid #555;">
    <br>
...
<table style="width:100%; table-layout:fixed; border-collapse: collapse;">
  <tr>
    <td><img src="ReadmeFolder/img1.png" width="100%" style="border-radius:5px;"></td>
    <td><img src="ReadmeFolder/img2.png" width="100%" style="border-radius:5px;"></td>
    <td><img src="ReadmeFolder/img3.png" width="100%" style="border-radius:5px;"></td>
    <td><img src="ReadmeFolder/img4.png" width="100%" style="border-radius:5px;"></td>
  </tr>
  <tr>
    <td><img src="ReadmeFolder/img5.png" width="100%" style="border-radius:5px;"></td>
    <td><img src="ReadmeFolder/img6.png" width="100%" style="border-radius:5px;"></td>
    <td><img src="ReadmeFolder/img7.png" width="100%" style="border-radius:5px;"></td>
    <td><img src="ReadmeFolder/img8.png" width="100%" style="border-radius:5px;"></td>
  </tr>
</table>
...
<p>This is my <b>first VR project</b> and is currently a work-in-progress as I continue to add new levels and more complex physics puzzles.</p>
<ul>
...
<blockquote>
  <b>A Note from the Developer:</b><br>
